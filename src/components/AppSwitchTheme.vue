<template>
  <div class="d-flex align-center">
    <input id="darkmode-toggle" type="checkbox" v-model="darkMode" />
    <label for="darkmode-toggle">
      ...
      <!-- Moon icon -->
      <svg class="moon" viewBox="0 0 24 24" fill="#000000" xmlns="http://www.w3.org/2000/svg">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
        <g id="SVGRepo_iconCarrier">
          <path
...
label:after {
  ...
  top: 2px;
  left: 2px;
  background: linear-gradient(180deg, #dac90e, #fffb84);
  border-radius: 36px;
