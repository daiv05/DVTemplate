...
const page = ref({ title: 'Temas y estilos' })
          ...
          <div id="hierarchy">
            <div class="foldercontainer text-lightText">
              ...
              <span class="file"
                ...
                <span>Estilos aplicados al componente TheAppDrawer (sidebar)</span></span
              >
              <span class="file"
              ...
              <span class="file"
                ...
                <span>Archivo principal</span></span
              >
            </div>
          </div>
        </AppBaseCard>
