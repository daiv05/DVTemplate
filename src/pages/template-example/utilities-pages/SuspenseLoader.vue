      ...
      <v-col cols="12">
        <AppBaseCard title="Suspense/Loader">
          <p>
            ...
            utilizar para mostrar una pantalla de carga en la aplicación. Este componente se utiliza en
            conjunto con el nuevo componente llamado <code>Suspense</code> (nativo de Vue 3) para
          ...
          <highlightjs :code="suspenseCode" language="html"></highlightjs>
          <v-alert
            class="my-4"
            type="info"
            variant="tonal"
